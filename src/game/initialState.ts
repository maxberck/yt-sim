...
projects:[],publishedVideos:[],playlists:[],series:[],contracts:[],
...
offers:[{id:'offer-1',company:'Nova Energy',type:'sponsor',title:'Intègre notre marque dans ta prochaine vidéo Gaming',amount:1800,minSubscribers:500},{id:'offer-2',company:'PixelForge',type:'sponsor',title:'Mention de 30 secondes dans une vidéo Tech',amount:3200,minSubscribers:1000},{id:'offer-3',company:'CreatorLab',type:'agency',title:'Accompagnement créateur · 10% de commission',commission:10,minSubscribers:5000}],worldCreators:[{id:'c1',name:'NéoPlay',category:'Gaming',subscribers:4200,reputation:38,growthRate:.006,active:true},{id:'c2',name:'TechLab',category:'Tech',subscribers:18000,reputation:62,growthRate:.004,active:true},{id:'c3',name:'MilaVlog',category:'Vlog',subscribers:76000,reputation:70,growthRate:.003,active:true}],
